...
// Crear empleado 
    ...
    public void createEmployee() {
        ...
        Empleados empleadoACrear = new Empleados(empleadoNombre, empleadoApellido, empleadoSalario, empleadoCargo, empleadoFechaInicio);

        empleadosControler.create(empleadoACrear);
    ...
    public void editEmployee() {
        ...
        if (editarEmpleado != null) {
            try {
                ...
                editarEmpleado.setFechaInicio(empleadoFechaInicio);
